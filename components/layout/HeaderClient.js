...
export default function HeaderClient({ categorias = [], promotionSettings = {} }) {
  ...
  const categoryLinks = categorias.map((categoria) => ({
    ...categoria,
    href: `/categoria/${categoria.slug}`,
  }));

  const algumaCategoriaAtiva = categoryLinks.some((categoria) =>
    ...
    <>
      <header className="header">
        <div className="topBar">
          {promotionSettings.promocao_global_ativa
            ? `Site todo com ${Number(promotionSettings.desconto_global_percentual)}% OFF`
